...
class TestAuthHeaderRollout:
    """Progressive rollout: send both the legacy secret and the Bearer token when both are configured,
    so recording-api accepts either and rollout is order-independent."""
